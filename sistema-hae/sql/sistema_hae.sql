...
--
-- Host: 127.0.0.1
-- Tempo de geração: 28/05/2025 às 18:16
...
INSERT INTO `inscricoes` (`id`, `usuario_id`, `edital_id`, `titulo`, `descricao`, `arquivo_pdf`, `status`, `comentario_coordenador`, `data_envio`) VALUES
(3, 4, 1, '4124', 'dsadsad', '', 'pendente', NULL, '2025-05-28 13:12:42');
...
(3, 'Administrador do Sistema', 'admin@fatec.com', 'admin', '$2y$10$XPkYuHK2iOZCSFO4UWhW8.0ZoxZzPyE65cd1ILq1IBSrxaTRhST26', 'admin', 'ativo', 1, '(19) 99999-9999'),
